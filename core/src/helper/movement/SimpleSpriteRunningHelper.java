...
public class SimpleSpriteRunningHelper {
    ...
    public SimpleSpriteRunningHelper(GameAssets gameAssets, String animalType, String animalName, int[] frameCounts, boolean startFlipped) {
    ...
    public void loadAnimations() {
        ...
        animations.put("runningUp", createAnimation(animalName + "_Walk_Up", frameCounts[0], atlasPath));
        animations.put("runningDown", createAnimation(animalName + "_Walk_Down", frameCounts[1], atlasPath));
        animations.put("runningHorizontal", createAnimation(animalName + "_Walk_Side", frameCounts[2], atlasPath));
    }
